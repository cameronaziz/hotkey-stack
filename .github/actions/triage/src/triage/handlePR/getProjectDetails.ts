 ...
 */
const getProjectDetails = async (octokit: Project.Github, projectBoardLink: string): Promise<Project.ProjectInfo | null> => {
	...
	const projectDetails = await octokit.graphql<API.GetProjectQuery>(
